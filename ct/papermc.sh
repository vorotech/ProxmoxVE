#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/vorotech/ProxmoxVE/refs/heads/add_papermc_minecraft_server_lxc/misc/build.func)
...
echo -e "${INFO}${YW} Conect it with Minecraft Client using the following address:${CL}"
echo -e "${TAB}${GATEWAY}${BGN}${IP}:19132${CL}"
